...
During a 1985 lecture \href{https://en.wikipedia.org/wiki/Paul_Erd\%C5\%91s}{Paul Erd\H{o}s} stated ``You don't have to believe in God, but you should
    ...
    more profound investigations. Finally, there also exists \href{https://stacks.math.columbia.edu/}{The Stacks project} which is an open source textbook about 
    \href{https://stacks.math.columbia.edu/about}{``algebraic stacks and the algebraic geometry that is needed to define them.''}. This project is the most similar to what \emph{The Compendium} tries to
    be.
...
\section{Version History}
	...
	\subsection{v0.0.5 (4/21/2020)}
		...
		a function}, and \hyperref[subsec:negativepart]{the negative part of a function}. Also, added a sentence in the introduction about \href{https://stacks.math.columbia.edu/about}{The Stacks 
		project}.
\end{document}
